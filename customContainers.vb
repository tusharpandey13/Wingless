...
Class GhostTabControlLagFree
    ...
    Sub refreshbitmap()
        ...
        bg.DrawImage(DrawRoundRectangle1(rct(Me), 5, 4, col(_backcolor, 0.97), col(100, rescol(_backcolor)), -0.5), 0, 0, Width, Height)
        bg.FillRectangle(mb(_backcolor), rct(1, 1, Width - 3, 34))
        bg.DrawLine(mp(col(60, rescol(_backcolor))), 1, 34, Width - 3, 34)
        bg.DrawLine(mp(col(60, rescol(_backcolor))), 1, 1, Width - 3, 1)
        bg.Dispose()
        Invalidate()
    End Sub
