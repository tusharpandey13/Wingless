...
#End Region
    ...
    Public Shadows Sub UpdateBounds()
        ...
        SetWindowPos(Handle, ParentForm.Handle, ParentForm.Left - ShadowSize, ParentForm.Top - ShadowSize + 5, ParentForm.Width + ShadowSize * 2 + 1, ParentForm.Height + ShadowSize * 2, SetWindowPosFlags.FrameChanged)
    End Sub
